...
[source,bash]
----
oc new-app jenkins-persistent --param ENABLE_OAUTH=true --param MEMORY_LIMIT=2Gi --param VOLUME_CAPACITY=10Gi --param JENKINS_OPTS="-Dhudson.slaves.NodeProvisioner.initialDelay=0" -n gpte-jenkins
